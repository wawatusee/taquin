...
function joue(evt) {
    ...
    //pieceInvisible prend l'ordre de la piece cliquée, et piece cliquée prend l'ordre de la piece invisible
    ...
    //evt.target.style.order=nouvelleOrdrePieceCliquee;
    //ordrePieceInvisible=14;
    }else{
    console.log(evt);
